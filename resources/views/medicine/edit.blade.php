                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                   placeholder="{{ __('pages.name') }}" value="{{$medicine->name}}"
                                                   name="name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                   ...
                                                   name="strength" value="{{$medicine->generic_name}}">
                                        </div>
                                    </div>
                                            ...
                                            <select class="select2 form-select" id="select2-basic"
                                                ...
                                                @foreach($category as $leafs)
                                                    <option value="{{$leafs->id}}"
                                                            @if($medicine->category_id == $leafs->id) selected @endif>{{$leafs->name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" step="0.01" id="first-name-column" class="form-control"
                                                   placeholder="{{ __('pages.price') }}" name="price"
                                            ...
                                            <select class="select2 form-select" id="select2-basic"
                                                ...
                                                @foreach($vendors as $vendor)
                                                    <option value="{{$vendor->id}}"
                                                            @if($medicine->vendor_id == $vendor->id) selected @endif>{{$vendor->name}} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="select2 form-select" id="select2-basic"
                                                ...
                                                @foreach($supplier as $leafs)
                                                    <option value="{{$leafs->id}}"
                                                            @if($medicine->supplier_id == $leafs->id) selected @endif>{{$leafs->name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" step="0.01" id="first-name-column" class="form-control"
                                                   placeholder="{{ __('pages.buy_price') }}" name="buy_price"
                                                   value="{{$medicine->buy_price}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
