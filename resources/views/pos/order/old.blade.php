    ...
    <div class="row justify-content-md-end">
        <div class="col-md-8 col-lg-8">
            <dl class="row text-right pvl39">
                ...
                <dd class="col-5">{{\App\CPU\Helpers::currency_converter(round($total,2))}}</dd>
                
                <dt class="col-7">{{\App\CPU\translate('extra_discount')}}:</dt>
                <dd class="col-5">{{\App\CPU\Helpers::currency_converter(round($order->discount,2))}}</dd>
                
                <dt class="col-7" >{{\App\CPU\translate('paid')}}:</dt>
                <dd class="col-5">{{\App\CPU\Helpers::currency_converter(round($paid,2))}}</dd>
                
                <dt class="col-7" >{{\App\CPU\translate('due')}}:</dt>
                <dd class="col-5">{{\App\CPU\Helpers::currency_converter(round($order->due_price,2))}}</dd>
                
                <dt class="col-7 pvl40">{{\App\CPU\translate('Total')}}:</dt>
                <dd class="col-5 pvl40">{{\App\CPU\Helpers::currency_converter(round($order->total_price,2))}}</dd>
            </dl>
        </div>
    </div>
