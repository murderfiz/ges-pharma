@extends('layouts.app')
@section('title', __('pages.categories'))
@section('custom-css')
...
<section class="app-user-list">
  <div class="card">
    <div class="card-body border-bottom">
        <h4 class="card-title">{{ __('pages.categories') }}</h4>
            <div class="dt-action-buttons text-xl-end text-lg-start text-lg-end text-start "><div class="dt-buttons"><a class="dt-button btn btn-primary btn-add-record ms-2" tabindex="0" aria-controls="DataTables_Table_0" href="{{ route('category.add') }}"><span>{{ __('pages.category_add') }}</span></a> </div>
        </div>
    </div>
