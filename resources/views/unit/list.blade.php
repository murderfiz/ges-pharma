...
<section class="app-user-list">
    ...
    <div class="card-body border-bottom">
        <h4 class="card-title">{{ __('pages.units') }}</h4>
            <div class="dt-action-buttons text-xl-end text-lg-start text-lg-end text-start "><div class="dt-buttons"><a class="dt-button btn btn-primary btn-add-record ms-2" tabindex="0" aria-controls="DataTables_Table_0" href="{{ route('unit.add') }}"><span>{{ __('pages.unit_add') }}</span></a> </div>
        </div>
    </div>
