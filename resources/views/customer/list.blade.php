    ...
    <section class="app-user-list">
        <div class="card">
            <div class="card-header bg-transparent">
                <h4 class="card-title">{{ __('pages.customer_list') }}</h4>
                <div class="">
                    <a class="btn btn-success" href="{{ route('customer.send_email') }}"><i class="fa fa-at"></i> Send
                        Email</a>
                </div>
            </div>
                ...
                <table class="user-list-table table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>{{ __('pages.due') }} {{ Auth::user()->shop->currency }}</th>
