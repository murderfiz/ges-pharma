                    ...
                    <div class="card-body">
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img class="img-fluid rounded-circle mb-2" src="{{ \App\CPU\Helpers::globalAsset($customer->image) }}"
                        ...
                        <div class="d-flex justify-content-around my-2 pt-75">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-75">
                                    <h4 class="mb-0">{{ App\CPU\Helpers::priceFormat($customer->due) }}</h4>
                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-75">
                                    ...
                                    <span
                                        class="fw-bold">{{ App\CPU\Helpers::priceFormat($invoice->sum('paid_amount')) }}</span>
                                </li>
                                <li class="mb-75">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('pages.customer_invoice') }}</h4>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($invoice as $item)
                                        <tr>
                                            ...
                                            <td>{{ App\CPU\Helpers::priceFormat($item->paid_amount) }}</td>
