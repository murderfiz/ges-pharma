...
<div class="table-responsive">
    ...
    padding: 0px 0;">INVOICE</h4>
                ...
                <table style="width: 100%">
                    ...
                    @for ($i = 0; $i < $count; $i++)
                        ...
                        <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            ...
                            <td class="text-right"
                                style="border-bottom: none;vertical-align: top;font-size: 12px;text-align: center ">{{number_format($amount,2)}}</td>
                        </tr>
                        @php
                            }
                        @endphp
            ...
            @php
                ...
                $grand_total = ($total + $total_vat_amount + $igta+$taxAmount) - $invoice->discount;
            @endphp
            <section style="line-height: 1.23; font-size: 12px; border-top: 2px solid #000;">
                <table style="width: 100%">
                    ...
                    <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        ...
                        <td style="text-align: right; font-size: 12px; width: 70%">{{number_format($total_vat_amount,2)}}</td>
                    </tr>
                    <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        <td style="text-align: right; font-size: 12px; width: 70%">GST/ Tax Amount:</td>
                        <td style="text-align: right; font-size: 12px; width: 70%">{{number_format($taxAmount,2)}}</td>
                    </tr>
                    <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        <td style="text-align: right; font-size: 12px; width: 70%">IGTA:</td>
                        <td style="text-align: right; font-size: 12px; width: 70%">{{number_format($igta,2)}}</td>
                    </tr>
                    <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                    ...
                    <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        ...
                        <td style="text-align: right; font-size: 12px; width: 70%">{{number_format($grand_total,2)}}</td>
                    </tr>
                </table>
            </section>
            @php
            ...
            <section style="line-height: 1.222;">
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="font-size: 12px;text-align: right;">{{number_format($grand_total,2)}}</td>
                    </tr>
                    <tr>
