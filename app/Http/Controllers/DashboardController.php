...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Today report
        $data['today_sell'] = Invoice::whereDate('created_at', $date)->count();
        $data['today_purchase'] = Purchase::whereDate('created_at', $date)->count();

        $data['today_sell_amount'] = Invoice::whereDate('created_at', $date)->sum('total_price');
        $data['today_purchase_amount'] = Purchase::whereDate('created_at', $date)->sum('total_price');

        $data['today_received'] = InvoicePay::whereDate('created_at', $date)->sum('amount');
        $data['today_paid'] = PurchasePay::whereDate('created_at', $date)->sum('amount');


        // Total Amount report
        $data['total_sell_amount'] = Invoice::sum('total_price');
        ...
        $data['stockout_medicines'] = Medicine::select('id','name')
        ...
        $data['total_customer_due'] = Customer::sum('due');
