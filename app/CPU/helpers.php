...
class Helpers
{
    ...
    {
        return Helpers::appSetting('currency') . '' . number_format($price, 2);
    }

    public static function appSetting($name, $default = null)
    {
    ...
    public static function globalAsset($file){
        if (!empty($file)){
            return  asset($file);
        }
    ...
    public static function successAlert($message = 'Success')
    {
       return Toastr::success($message, '', ['progressBar' => true, 'closeButton' => true, 'positionClass' => 'toast-top-right']);
    }


    public static function errorAlert($message = 'Something Went Wrong')
    {
        return Toastr::error($message, '', ['progressBar' => true, 'closeButton' => true, 'positionClass' => 'toast-top-right']);
    }
